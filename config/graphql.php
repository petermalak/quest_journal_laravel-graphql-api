...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                'quest' => App\GraphQL\Queries\Quest\QuestType::class,
                'quests' => App\GraphQL\Queries\Quest\QuestsType::class,
                'category' => App\GraphQL\Queries\Category\CategoryType::class,
                'categories' => App\GraphQL\Queries\Category\CategoriesType::class,
            ],
            'mutation' => [
